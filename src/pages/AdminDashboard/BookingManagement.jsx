...
import { Edit2, Save, XCircle, Filter } from "lucide-react";
...
const BookingManagement = () => {
  ...
  const fetchBookings = async () => {
    try {
      ...
      if (response.success) {
        ...
        setBusReservations(response.bus_reserve || []);
      } else {
  ...
  const applyFilter = () => {
    ...
    if (statusFilter !== "all") {
      filtered = bookings.filter((booking) => booking.booking_status === statusFilter);
    }
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              {filteredBookings.length === 0 ? (
                <p className="text-center text-gray-600 p-4 bg-gray-50 rounded-lg">No bookings found</p>
              ) : (
                <>
            ...
            <div className="p-6">
              ...
              {busReservations.length === 0 ? (
                <p className="text-center text-gray-600 p-4 bg-gray-50 rounded-lg">No reservations found</p>
              ) : (
                <>
                  <div className="overflow-x-auto">
                    <table className="w-full border-collapse">
